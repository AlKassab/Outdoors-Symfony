...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        if (!$('body').hasClass('sidebar-top') && windowWidth > 1220)  {
            ...
            $.backstretch(["http://localhost/outD/web/images/gallery/bg1.jpg", "http://localhost/outD/web/images/gallery/bg2.jpg", "http://localhost/outD/web/images/gallery/bg3.jpg", "http://localhost/outD/web/images/gallery/bg4.jpg"],
