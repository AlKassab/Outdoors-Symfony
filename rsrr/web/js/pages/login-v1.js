...
$(function() {
    ...
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["http://localhost/outD/web/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["http://localhost/outD/web/images/gallery/login4.jpg", "http://localhost/outD/web/images/gallery/login3.jpg", "http://localhost/outD/web/images/gallery/login2.jpg", "http://localhost/outD/web/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
